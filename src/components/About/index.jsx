        ...
        <section className={style.section} id="quem_sou">
            ...
            <ul className={style.contratar}>
                <ol className={style.programador}>
                    ...
                    <a href="./assets/curriculoDEV.pdf" download="curriculoDEV.pdf">Baixar Curriculo</a>
                </ol>
                <ol className={style.freelancer}>
                    ...
                    <a href="./assets/curriculoDEV.pdf" download="curriculoDEV.pdf">Vamos Trabalhar Juntos</a>
                </ol>
            </ul>
